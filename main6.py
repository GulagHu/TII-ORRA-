...
if __name__ == '__main__':
    ...
    '''-------------------------Test 6: d_bar = 20, I = 10, delta = 0.02---------------------------'''

    workbook6 = xw.Workbook(file_path + 'test6.xlsx')
    ...
    for name in algo_names:
        exec('worksheet_' + name + ' = workbook6.add_worksheet(\'' + name + '\')')
        ...
        for s in range(num_samples):
            ...
            for name in algo_names:
                if name in ['NMWU', 'NMWU_S']:
                    ...
                    print('Workbook 6,', name, ', T =', str(T), ', sample', str(s + 1))
                else:
                    start = time.time()
