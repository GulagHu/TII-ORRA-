...
if __name__ == '__main__':
    ...
    '''-------------------------Test 7: d_bar = 10, I = 20, delta = 0.05---------------------------'''

    workbook7 = xw.Workbook(file_path + 'test7.xlsx')
    ...
    for name in algo_names:
        exec('worksheet_' + name + ' = workbook7.add_worksheet(\'' + name + '\')')
        ...
        for s in range(num_samples):
            ...
            for name in algo_names:
                if name in ['NMWU', 'NMWU_S']:
                    ...
                    print('Workbook 7,', name, ', T =', str(T), ', sample', str(s + 1))
                else:
                    start = time.time()
