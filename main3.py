...
if __name__ == '__main__':
    ...
    '''-------------------------Test 3: d_bar = 10, I = 20, delta = 0.02---------------------------'''

    workbook3 = xw.Workbook(file_path + 'test3.xlsx')
    ...
    for name in algo_names:
        exec('worksheet_' + name + ' = workbook3.add_worksheet(\'' + name + '\')')
        ...
        for s in range(num_samples):
            ...
            for name in algo_names:
                if name in ['NMWU', 'NMWU_S']:
                    ...
                    print('Workbook 3,', name, ', T =', str(T), ', sample', str(s + 1))
                else:
                    start = time.time()
